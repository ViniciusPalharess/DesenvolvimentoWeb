...
function adicionar(produto) {
  if (produtos.value[produto].quantidade > 0) {

    carrinhos.value.items.push(
      { ...produtos.value[produto], preco: produtos.value[produto].quantidade * produtos.value[produto].preco }
    );

    carrinhos.value.total = carrinhos.value.total + produtos.value[produto].preco * produtos.value[produto].quantidade
...
function incrementarContador(produto) {
  produtos.value[produto].quantidade++
}
    ...
    <div class="produtos">
      ...
      <div v-for="produto in produtos" :key="produto.id" class="card">
        ...
        <div class="contador">
          ...
          {{ carrinhos[produto.id - 1].quantidade }}
